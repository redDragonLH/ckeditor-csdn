...
CKEDITOR.plugins.add( 'basicstyles', {
	...
	icons: 'bold,italic,underline,strike,subscript,superscript,h1,h2,h3', // %REMOVE_LINE_CORE%
	hidpi: true, // %REMOVE_LINE_CORE%
	init: function( editor ) {
		editor.config.csdn_stlye_url ? editor.addContentsCss(editor.config.csdn_stlye_url ) : '';
		var order = 0;
		...
		addButtonCommand( 'h1', lang.h1, 'h1', config.coreStyles_h1 );
		addButtonCommand( 'h2', lang.h2, 'h2', config.coreStyles_h2 );
		addButtonCommand( 'h3', lang.h3, 'h3', config.coreStyles_h3 );
 ...
 */
 ...
 // CSDN后添加的 H1-H3
 CKEDITOR.config.coreStyles_h1 = { element: 'h1' };
 CKEDITOR.config.coreStyles_h2 = { element: 'h2' };
 CKEDITOR.config.coreStyles_h3 = { element: 'h3' };
