	...
	CKEDITOR.plugins.add( 'chart', {
		...
		init: function( editor ) {
										...
										[
											{
												...
												labelStyle: 'display:block;padding: 0 8px 4px 0;',
												items: [
												...
												typeStyle: 'border: 1px solid #CCCCCC;',
												style: 'background-color: #FFFFFF;font-size: 14px;color: #4D4D4D;',
											...
											},
											{
												...
												labelLayout: 'horizontal',
												// Align vertically, otherwise labels are a bit misplaced.
												labelStyle: 'display:block;width:40px;float:right;',
												width: '100px',
												setup: function( widget ) {
			...
			editor.widgets.add( 'chart', {
				...
				pathName: 'chart',
				toolbar: 'insert,17',  // 自定义属性，toolbar 位置
