	...
	var templateSource = '<div class="cke_reset_all {editorId} {editorDialogClass} {hidpi}' +
		...
		'<table class="cke_dialog ' + CKEDITOR.env.cssClass + ' cke_{langDir}"' +
			...
			'<div class="cke_dialog_body" role="presentation">' +
				...
				'<a id="cke_dialog_close_button_{id}" class="cke_dialog_close_button" href="javascript:void(0)" title="{closeTitle}" role="button"><span class="cke_label"><svg class="icon" aria-hidden="true"><use xlink:href="#csdnc-times"></use></svg></span></a>' +
