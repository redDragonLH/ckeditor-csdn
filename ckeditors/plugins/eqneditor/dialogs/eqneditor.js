...
{	
	...
	return {
		...
		onOk : function() {
			...
			eqn.setAttribute( 'class', 'mathcode');
			...
			document.getElementById('CClatex'+window.CCounter).value='';
			document.getElementById('CCequation'+window.CCounter).setAttribute('src','http://www.codecogs.com/images/spacer.gif')
		}
	};
});
