		...
		editor.on( 'doubleclick', function(evt) 
		{
			...
			if (element && element.is('img')) 
			{
				...
				if(sName!=null)
				{
					...
					document.getElementById('CCequation'+window.CCounter).setAttribute('src',element.getAttribute('src'))
					evt.stop();
					return true	
				}
			}
