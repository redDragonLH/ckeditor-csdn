...
CKEDITOR.dialog.add( 'image2', function( editor ) {
	...
	var regexGetSizeOrEmpty = /(^\s*(\d+)(px)?\s*$)|^$/i,
		...
		lockResetStyle = 'margin-top:42px;width:40px;height:20px;',
				...
				elements: [
					{
						...
						labelStyle: 'font-weight:bold;font-size: 16px;margin-top:8px;margin-bottom:8px;display:none',
						style: 'height:40px;padding-top: 24px;',
					},
					{
						type: 'fileButton',
						id: 'uploadButton',
						filebrowser: 'info:src',
						label: lang.btnUpload,
						style: 'color:#fff;margin-top:16px;padding-top:8px;padding-bottom:8px;border:1px solid #bbb',
						'for': [ 'file', 'file' ]
					}
				]
			}
